...
- **Count:** 160 test files across services (88), components (35), utils (17), stores (9), constants (4), hooks (3), router (2), config (1), test (1) — measured by `npm run docs:check` (total and breakdown), not maintained by hand
