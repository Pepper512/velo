...
- **Count:** 174 test files across services (96), components (38), utils (18), stores (9), constants (4), hooks (3), config (3), router (2), test (1) — measured by `npm run docs:check` (total and breakdown), not maintained by hand
