...
- **Count:** 163 test files across services (90), components (35), utils (17), stores (9), constants (4), hooks (3), config (2), router (2), test (1) — measured by `npm run docs:check` (total and breakdown), not maintained by hand
