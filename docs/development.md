...
- **Count:** 154 test files across services (83), components (34), utils (17), stores (9), constants (4), hooks (3), router (2), config (1), test (1) — measured by `npm run docs:check` (total and breakdown), not maintained by hand
