  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        tips: [
          { text: "Automatic: when you send to someone outside your own domain, a reminder is set for you — after the delay you chose under Settings → Sending (3 days unless you change it), at 9:00, never on a weekend. The composer shows \"Remind me if no reply\" before you send; untick it for that message." },
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        summary: "Risky links stop and show you where they really go.",
        description:
          "When you click a link that the phishing detector rates suspicious or high risk, a confirmation dialog appears before anything opens. It shows the full destination URL, the link's visible text if it differs, and the specific rules the link tripped, with Go Back as the default and Open Anyway as the escape. Links the detector rates safe open directly with no extra click. The sensitivity setting decides where the line sits, and allowlisting a sender turns the dialog off for their mail.",
        tips: [
          { text: "Only links the detector flags show the dialog — safe links open at once." },
          { text: "Raise the sensitivity in Settings > Security to be asked more often, lower it to be asked less." },
          { text: "Read the full URL and the tripped rules before choosing Open Anyway." },
          { text: "Trust a sender from the warning banner to stop asking for their mail." },
        ],
      },
    ],
  },
