...
171 test files across services (94), components (38), utils (17), stores (9), constants (4), hooks (3), config (3), router (2), test (1). Both numbers are measured by `npm run docs:check`, not maintained by hand.
