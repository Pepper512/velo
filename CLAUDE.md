...
156 test files across services (85), components (34), utils (17), stores (9), constants (4), hooks (3), router (2), config (1), test (1). Both numbers are measured by `npm run docs:check`, not maintained by hand.
