...
185 test files across services (104), components (41), utils (18), stores (9), constants (4), hooks (3), config (3), router (2), test (1). Both numbers are measured by `npm run docs:check`, not maintained by hand.
